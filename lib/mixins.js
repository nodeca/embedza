...
mixins.push({
  id: 'meta',
  fn: async function meta_mixin(env) {
    debug('meta');
...
mixins.push({
  ...
  fn: async function twitter_thumbnail_mixin(env) {
...
mixins.push({
  id: 'twitter-player',
  fn: async function twitter_player_mixin(env) {
...
mixins.push({
  id: 'og-player',
  fn: async function og_player_mixin(env) {
    debug('og-player');
...
mixins.push({
  id: 'og-thumbnail',
  fn: async function og_thumbnail_mixin(env) {
    debug('og-thumbnail');
...
mixins.push({
  id: 'oembed-player',
  fn: async function oembed_player_mixin(env) {
    debug('oembed-player');
...
mixins.push({
  id: 'oembed-photo',
  fn: async function oembed_photo_mixin(env) {
    debug('oembed-photo');
...
mixins.push({
  id: 'oembed-icon',
  fn: async function oembed_icon_mixin(env) {
    debug('oembed-icon');
...
mixins.push({
  id: 'oembed-thumbnail',
  fn: async function oembed_thumbnail_mixin(env) {
...
mixins.push({
  id: 'oembed-rich',
  fn: async function oembed_rich_mixin(env) {
    debug('oembed-rich');
...
mixins.push({
  id: 'favicon',
  fn: async function favicon_mixin(env) {
    debug('favicon');
...
mixins.push({
  id: 'logo',
  fn: async function logo_mixin(env) {
    debug('logo');
