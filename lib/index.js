...
Embedza.prototype.render = function (url, type, callback) {
  ...
  Promise.resolve(this.__render__(url, type)).asCallback(callback);
};


Embedza.prototype.__render__ = async function (url, type) {
  debug('render');
...
Embedza.prototype.info = function (url, callback) {
  ...
  Promise.resolve(this.__info__(url)).asCallback(callback);
};

/* eslint-enable consistent-return */


Embedza.prototype.__info__ = async function (url) {
  debug('info');
